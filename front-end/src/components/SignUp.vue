        ...
        <div class="row">
            ...
            <div class="col-md-2 col-lg-4">
                <div class="mt-4">
                    ...
                    <input class="border-rounded" type="text" v-model="name" placeholder="Enter Name">
                </div>
                <div class="mt-4">
                ...
                <div class="mt-4">
                    <button id="registerBTN" v-on:click="signUp" class="btn btn-rounded" >Sign Up</button>
                </div>
                <div class="mt-4">
                    <router-link to="/login" id="loginID">Already have an account? Log In</router-link>
                </div>    
            </div>
            <div class="col-md-2 col-lg-4"></div>
        </div>
